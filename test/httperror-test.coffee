...
vows = require("vows")
vows.describe("httperror module interface").addBatch("When we require the http error module":
  topic: ->
    require "../lib/httperror"

  "we get an object": (httperror) ->
    assert.isObject httperror
    return

  "which includes HTTPError": (httperror) ->
