...
suite = vows.describe("access token interface")
testSchema =
  pkey: "access_token"
  fields: [
    "token_secret"
...
mb = modelBatch("accesstoken", "AccessToken", testSchema, testData)
mb["When we require the accesstoken module"]["and we get its AccessToken class export"]["and we create an accesstoken instance"]["auto-generated fields are there"] = (err, created) ->
