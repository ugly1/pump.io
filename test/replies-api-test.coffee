...
suite.addBatch "When we set up the app":
  ...
  "and we get new credentials":
    topic: ->
      newCredentials "macdonald", "the|old|flag", @callback
      return
  ...
  "and we make two new sets of credentials":
    topic: ->
      Step (->
        newCredentials "mackenzie", "rail*road", @parallel()
        newCredentials "thompson", "bering*sea", @parallel()
        return
      ), @callback
      return
  ...
  "and we make two more new sets of credentials":
    topic: ->
      Step (->
        ...
        newCredentials "borden", "over there,", @parallel()
        return
      ), @callback
      return
