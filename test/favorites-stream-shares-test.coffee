  ...
  "and we register a client":
    ...
    "and we register two users":
      ...
      "and the first one posts a bunch of notes and the second one shares every other one":
        ...
        "and we check their favorites stream with same user credentials": sameUser("http://localhost:4815/api/user/click/favorites")
        "and we check their favorites feed with client credentials": justClient("http://localhost:4815/api/user/click/favorites")
        "and we check the first user's favorites feed with different user credentials": otherUser("http://localhost:4815/api/user/click/favorites")
